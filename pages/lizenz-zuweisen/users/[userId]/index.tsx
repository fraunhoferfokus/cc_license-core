...
export default function LizenzUserLayout({
    ...
    const { licenseDefinitions, licenseAssignments, users, setSelectedUserIds, loadingUsers, licensesLoading } = useStore(state => state)
    const selectedUserIds = decodeURIComponent(user_ids)?.split(',')
    ...
    return (<>
        <LizenzLayout
            currentlySelectedMedium={selectedMedia}
        >
